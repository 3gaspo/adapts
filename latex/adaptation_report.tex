...
\code{k_ablation.slurm} & nine selected pipelines, $K\in\{1,3,5,10,15,20\}$ only \\
...
Run the formulation fronts, filter their outputs into an expanded candidate
set, then run the $K$ study; \code{screen.slurm} is not rerun. Publication

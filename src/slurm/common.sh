...
require_experiment_family() {
  case "${EXPERIMENT_FAMILY:-}" in
    extraction|baselines|gates|benchmark|screen|mixed_quantity_ablation|fourier_retrieval_ablation|offline_datastore_ablation|retrieval_scope_ablation|horizon_baselines_ablation|convex_baselines_ablation|delta_baselines_ablation|catboost_ablation|training_loss_ablation|k_ablation|h_ablation|l_ablation|ts_ifa|ts_ifa_h_ablation|ts_ifa_l_ablation|ts_ifa_meta_ridge|ts_ifa_meta_neural|crossrag|sota_benchmark|tsrag|tables) ;;

...
_METHOD_LABELS = {
    "vanilla": "vanilla",
    "context_forecast": "ctx",
    "aggr_y": "aggr-Y",
    "y_mean": "mean-Y",
    "aggr_y_mix_shared": "aggr-Y-lambda-s",
    "aggr_y_mix_horizon": "aggr-Y-lambda-h",
    "context_ridge_shared": "VC-ridge-s",
    "context_ridge_horizon": "VC-ridge-h",
    "aggr_y_ridge_shared": "aggr-Y-ridge-s",
    "aggr_y_ridge_horizon": "aggr-Y-ridge-h",
    ...
    "catboost_context_classifier_shared": "cb-C-cls-s",
    "catboost_context_classifier_horizon": "cb-cls-h",
    "catboost_context_regressor_shared": "cb-C-reg-s",
    "catboost_context_regressor_horizon": "cb-reg-h",
    "bayes_aggr_y_shared": "bayes-Y-s",
    "bayes_aggr_y_horizon": "bayes-Y-h",
    "catboost_aggr_y_classifier_shared": "cb-Y-cls-s",
    "catboost_aggr_y_classifier_horizon": "cb-Y-cls-h",
    "catboost_aggr_y_regressor_shared": "cb-Y-reg-s",
    "catboost_aggr_y_regressor_horizon": "cb-Y-reg-h",
    "oracle_context_shared": "oracle-C-s",
